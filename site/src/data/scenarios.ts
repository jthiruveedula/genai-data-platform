...
export interface ScenarioStat {
  /** The one cited number worth animating — never a derived/rounder figure, same rule as `impact`. */
  value: number;
  decimals?: number;
  prefix?: string;
  suffix: string;
...
export interface RealCaseStudy {
  ...
  /** Optional — omitted where the story has no single clean headline number to animate (see impact.fix instead). */
  stat?: ScenarioStat;
  sourceUrl: string;
...
export const CASE_STUDIES: Record<string, ModuleCaseStudy> = {
  "00-foundations": {
    gcp: {
      ...
      stat: { value: 81, suffix: "%", label: "clinical accuracy" },
    ...
    aws: {
      ...
      stat: { value: 80, suffix: "%", label: "productivity improvement" },
    ...
    azure: {
      ...
      stat: { value: 60000, suffix: "", label: "human tax pros freed for complex returns" },
      sourceUrl:
    ...
    oss: {
      ...
      stat: { value: 20, suffix: "B+", label: "vectors on self-hosted Qdrant" },
  ...
  "10-ingestion": {
    gcp: {
      ...
      stat: { value: 36.2, decimals: 1, suffix: "%", label: "of revenue traced to this pipeline" },
    ...
    aws: {
      ...
      stat: { value: 90, prefix: "~", suffix: "%", label: "accuracy, under 2 min/package" },
      sourceUrl:
    ...
    azure: {
      ...
      stat: { value: 30000, suffix: "", label: "work hours saved every month" },
    ...
    oss: {
      ...
      stat: { value: 40, prefix: "$", suffix: "K+/mo", label: "saved in inference costs" },
  ...
  "15-chunking": {
    ...
    aws: {
      ...
      stat: { value: 90, suffix: "%", label: "faster to configure a new schema" },
    ...
    azure: {
      ...
      stat: { value: 11000, suffix: "", label: "work hours saved every year" },
  ...
  "20-embeddings": {
    gcp: {
      ...
      stat: { value: 2.5, decimals: 1, suffix: "x", label: "the site's average conversion rate" },
    ...
    aws: {
      ...
      stat: { value: 75, suffix: "%", label: "less time per campaign search" },
    ...
    oss: {
      ...
      stat: { value: 100, prefix: "~", suffix: "x", label: "less storage, recall held at ~98%" },
  ...
  "25-serving": {
    gcp: {
      ...
      stat: { value: 5, suffix: "x", label: "faster responses than before" },
    ...
    aws: {
      ...
      stat: { value: 77, suffix: "%", label: "lower cost per chat" },
    ...
    azure: {
      ...
      stat: { value: 3, prefix: "~", suffix: "x", label: "faster response time" },
      sourceUrl:
    ...
    oss: {
      ...
      stat: { value: 60, suffix: "", label: "GPUs freed by vLLM tuning" },
  ...
  "35-retrieval": {
    gcp: {
      ...
      stat: { value: 3.9, decimals: 1, suffix: "%", label: "hallucination rate (down from 34.1%)" },
    ...
    aws: {
      ...
      stat: { value: 4, suffix: "x", label: "cheaper than the on-premises setup" },
    ...
    azure: {
      ...
      stat: { value: 95000, suffix: "", label: "auditors served across 140+ countries" },
    ...
    oss: {
      ...
      stat: { value: 100, suffix: "K RPS", label: "write-spike throughput handled" },
      sourceUrl: "https://product.hubspot.com/blog/building-the-ai-retrieval-infrastructure-behind-20-billion-vectors-at-hubspot",
    },
  },
  "38-multimodal": {
    gcp: {
      ...
      stat: { value: 2.6, decimals: 1, suffix: "%", label: "revenue increase from Snap-to-Shop" },
    ...
    aws: {
      ...
      stat: { value: 90, suffix: "%", label: "lower total costs with S3 Vectors" },
    ...
    azure: {
      ...
      stat: { value: 1, suffix: "PB", label: "of broadcast video indexed" },
    ...
    oss: {
      ...
      stat: { value: 3, suffix: "x", label: "more revenue from AI-feature users" },
  ...
  "45-evaluation": {
    gcp: {
      ...
      stat: { value: 1000, suffix: "+", label: "AI applications de-risked" },
    ...
    aws: {
      ...
      stat: { value: 1, prefix: "<", suffix: "%", label: "misclassification rate (down from 20%)" },
    ...
    azure: {
      ...
      stat: { value: 17, suffix: "", label: "use cases shipped in 4 months" },
  ...
  "55-observability": {
    gcp: {
      ...
      stat: { value: 20, suffix: "M+/day", label: "requests observed and traced" },
      sourceUrl: "https://cloud.google.com/customers/galileo",
    },
    aws: {
      company: "Druva",
      ...
      stat: { value: 68, suffix: "%", label: "of issues resolved via traced agent workflows" },
    ...
    azure: {
      ...
      stat: { value: 50, suffix: "%", label: "cut in time-to-build" },
      sourceUrl: "https://www.microsoft.com/en/customers/story/23953-accenture-azure-ai-foundry",
      stretch: true,
    },
    oss: {
  ...
  "65-security": {
    gcp: {
      ...
      stat: { value: 85, suffix: "%", label: "cut in fine-tuned-LLM costs" },
    ...
    aws: {
      ...
      stat: { value: 99, prefix: "up to ", suffix: "%", label: "verification accuracy" },
    ...
    azure: {
      ...
      stat: { value: 1500, suffix: "", label: "students in the safe 8-week pilot" },
      sourceUrl:
  ...
  "75-finops": {
    gcp: {
      ...
      stat: { value: 75, suffix: "%", label: "lower ad-moderation costs" },
    ...
    aws: {
      ...
      stat: { value: 80, suffix: "%", label: "lower underwriting costs" },
    ...
    azure: {
      ...
      stat: { value: 40, prefix: ">", suffix: "%", label: "cost reduction from caching" },
  ...
  "85-agents": {
    gcp: {
      ...
      stat: { value: 90, prefix: "up to ", suffix: "%", label: "faster research-briefing generation" },
    ...
    aws: {
      ...
      stat: { value: 68, suffix: "%", label: "of issues resolved by agents alone" },
      sourceUrl: "https://aws.amazon.com/solutions/case-studies/druva-agentcore-case-study/",
    },
    azure: {
      company: "ContraForce",
      ...
      stat: { value: 60, suffix: "x", label: "faster incident response" },
    ...
    oss: {
      ...
      stat: { value: 7000, prefix: "~", suffix: "", label: "engineering hours saved every month" },
